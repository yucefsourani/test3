...
for f in [os.path.join(cdir,"com.github.yucefsourani.halflchs.HALFLSC.png"),os.path.join(cdir,"utils.py"),os.path.join(cdir,"halflsc.ico"),os.path.join(cdir,"gpl.txt")]:
